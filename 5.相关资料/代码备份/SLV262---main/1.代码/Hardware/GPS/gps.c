...
void Gps_Msg_Show(void)
{
	...
	tp=gpsx.longitude;	   
	sprintf((char *)dtbuf,"E:%.f %1c",tp/=100000,gpsx.ewhemi);	//得到经度字符串
//	OLED_ShowF16x16(2,1,13);//经
//	OLED_ShowF16x16(2,3,14);//度
	OLED_ShowString(4,1,(char *)dtbuf);
	tp=gpsx.latitude;	   
	sprintf((char *)dtbuf,"N:%.f %1c",tp/=100000,gpsx.nshemi);	//得到纬度字符串
//	OLED_ShowF16x16(3,1,15);//纬
//	OLED_ShowF16x16(3,3,16);//度
	OLED_ShowString(4,9,(char *)dtbuf); 	 
